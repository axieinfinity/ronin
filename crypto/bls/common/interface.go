...
// github.com/ethereum/go-ethereum/crypto/bls. This package exists to prevent an import circular
// dependency.
package common
...
type Signature interface {
	...
	VerifyProof(pubKey PublicKey, msg []byte) bool
