...
func (tx *InternalTransferOrSmcCallEvent) Publish(opcode vm.OpCode, blockTime, order uint64, stateDB vm.StateDB, hash common.Hash, from, to common.Address, value *big.Int, input []byte, err error) error {
...
func (tx *InternalTransactionContractCreation) Publish(opcode vm.OpCode, blockTime, order uint64, stateDB vm.StateDB, hash common.Hash, from, to common.Address, value *big.Int, input []byte, err error) error {
	internal := types.InternalTransaction{
		Opcode:          opcode.String(),
		Order:           order,
		TransactionHash: hash,
