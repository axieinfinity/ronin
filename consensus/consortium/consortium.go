...
// Package consortium implements the proof-of-authority consensus engine.
package consortium
...
func (c *Consortium) snapshot(chain consensus.ChainReader, number uint64, hash common.Hash, parents []*types.Header) (*Snapshot, error) {
