...
func TestFindCheckpointHeader(t *testing.T) {
	...
	checkpointHeader := findCheckpointHeader(5, nil, parents, nil)
	...
	checkpointHeader = findCheckpointHeader(11, nil, parents, nil)
	...
	checkpointHeader = findCheckpointHeader(5, &mockChain, parents, nil)
	if checkpointHeader == nil {
	...
	checkpointHeader = findCheckpointHeader(
		5,
		&mockChain,
		nil,
